...
// All the functions in this file should be treated as a blackbox.
// You don't need to understand how it works, but only trust it will process like the function name indicates.
...
static int parse_routing_info(struct list_head *rtable, char *buf, int len)
{
	int n = 0;
